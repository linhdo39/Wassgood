...
import 'package:scanlator/pages/Caution.dart';
import 'package:scanlator/pages/Good.dart';
import 'package:scanlator/pages/Neutral.dart';
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Card(
                    elevation: 10,
                    child: ListTile(
                      leading: Image.asset("assets/sad.png"),
                      title: Text(
                        '   Neutral',
                        style: TextStyle(
                            color: Colors.red[300],
